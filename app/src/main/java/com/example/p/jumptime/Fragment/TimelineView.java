...
public class TimelineView extends RecyclerView {
    ...
    private void onDateSelected(int position, int year, int month, int day) {
        Toast.makeText(getContext(), "day is on date selected " + day + " position " + position, Toast.LENGTH_SHORT).show();
        if (position == selectedPosition) {
            centerOnPosition(selectedPosition);
            return;
        }
//здесь написать код для загрузки дел на день (смотри реализацию вкладки задания)
    ...
    public void setSelectedDate(int year, int month, int day) {
        Toast.makeText(getContext(), "day is Time Line View " + day, Toast.LENGTH_SHORT).show();
        ...
        TimelineViewHolder(View root) {
            ...
            root.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.d("TIMEPP", "BASTA" );
                    Intent intentLow = new Intent("NewDay");
                    intentLow.putExtra("LetsDay","gone");
                    intentLow.putExtra("position",position);
                    intentLow.putExtra("year",year);
                    intentLow.putExtra("month",month);
                    intentLow.putExtra("day",day);
                    LocalBroadcastManager.getInstance(getContext()).sendBroadcast(intentLow);
