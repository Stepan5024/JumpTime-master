...
/*
 * Добавление новой цели, сохранение введенных данный в БД firebase
 *
 *
 * */
public class AddGoal extends Fragment implements TextView.OnEditorActionListener {
    ...
    LinearLayout linear;
    //Содержит список из созданных програамно editText
    private List<View> allEds;
    private FirebaseUser user;
    private DatabaseReference myRef;
    private FirebaseDatabase database;
    String title = "Информация";
    String message = "Здесь вы можее ввести свою цель. Используйте жесты перелистывания для перехода на следующую страницу";
    String button1String = "Понятно";
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        android.app.AlertDialog.Builder ad = new android.app.AlertDialog.Builder(getContext());
        ...
        DataEnd = "";
        //анимированное перелистование, перехват жестов
        LinearLayout mainLayout = view.findViewById(R.id.main_layout);
        mainLayout.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN: // Пользователь нажал на экран
                        // fromPosition - координата по оси X начала выполнения операции
                        fromPosition = event.getX();
                        break;
                    case MotionEvent.ACTION_UP: // Пользователь отпустил экран
        ...
        int[] layouts = new int[]{R.layout.fragment_add_new_goal_kilo, R.layout.view};
        ...
        final DatePickerDialog.OnDateSetListener d = new DatePickerDialog.OnDateSetListener() {
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                DataEnd = (dayOfMonth + 1) + "." + monthOfYear + "." + year;
            ...
            public void onClick(View view) {
                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        //чтение всех элементов этого списка и запись в массив
