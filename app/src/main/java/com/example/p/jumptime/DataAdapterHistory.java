...
class DataAdapterHistory extends RecyclerView.Adapter<DataAdapterHistory.ViewHolder> {

    private LayoutInflater inflater;
    private ArrayList<TaskForRecyclerView> news;
    View view;

    DataAdapterHistory(Context context, ArrayList<TaskForRecyclerView> phones) {
        this.news = phones;
    ...
    @NonNull
    public DataAdapterHistory.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
         view = inflater.inflate(R.layout.recycler_view_cards, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final DataAdapterHistory.ViewHolder viewHolder, final int position) {
